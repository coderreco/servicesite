    ...
    <Container className="py-20 text-center lg:py-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-emerald-600">
          ...
          <span className="relative">made simple<span className="absolute inset-0 text-emerald-400 opacity-25 w-full h-full blur-xl">made simple</span></span>
          
        </span>{' '}
        for cleaning businesses.
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        Get a professional website for your cleaning business that <strong>ranks higher</strong> in search engines and <strong>converts more</strong> visitors into leads. <br/>Get started with a <strong>free mockup</strong> of your website.
      </p>
