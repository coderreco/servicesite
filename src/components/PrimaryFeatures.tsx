...
const features = [
  {
    title: 'Optimized',
    description:
      "Increase your visibility with a service-area page templates to support regional SEO.",
    image: screenshotPayroll,
  },
  {
    title: 'Performant',
    description:
      "Built to convert, designed to drive leads and sales from your ideal customers.",
    image: screenshotExpenses,
  },
  {
    title: 'Affordable',
    description:
      "Get a professional website tailored to your market without the cost of a custom build.",
    image: screenshotVatReturns,
  },
  {
    title: 'Efficient',
    description:
      'Overcome the challenges of managing a website generated by a booking service by using Webflow.',
