...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[200vh] flex-shrink-0 scale-[0.5] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 md:overflow-clip md:py-80"
    >
      <motion.h2
        style={{
        ...
        className="mb-20 text-center font-display text-6xl text-neutral-800"
      >
        {title || (
          <span>
    ...
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <Image
          ...
          alt="aceternity logo"
          fill
          className="object-top-center absolute inset-0 h-full w-full rounded-lg object-cover"
        />
      </motion.div>
    </div>
  )
