      ...
      >
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div>
            ...
            >
              Name<span className="align-super text-orange-500">*</span>
            </label>
          ...
          <div>
            <label
              ...
              className="block text-sm font-semibold leading-6 text-gray-900"
            >
              Email<span className="align-super text-orange-500">*</span>
            </label>
            <div className="mt-2.5">
              <input
                type="email"
          ...
          <div className="sm:col-span-2">
            <label
              ...
              className="block text-sm font-semibold leading-6 text-gray-900"
            >
              Phone number<span className="align-super text-orange-500">*</span>
            </label>
